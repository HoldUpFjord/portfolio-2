...
import { Flex, Skeleton, TiltFx } from "@/once-ui/components";
...
const SmartImageEffect: React.FC<SmartImageProps> = ({
  aspectRatio,
  height,
  alt = "",
  isLoading = false,
...
SmartImageEffect.displayName = "SmartImageEffect";

export { SmartImageEffect };
